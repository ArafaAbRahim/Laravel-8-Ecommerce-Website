                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" wire:submit.prevent="saveSettings">
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="email" placeholder="Email" class="form-control imput-md" wire:model="email" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" placeholder="Twiter" class="form-control imput-md" wire:model="twiter" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" placeholder="Facebook" class="form-control imput-md" wire:model="facebook" />
